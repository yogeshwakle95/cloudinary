...
const Home = () => {
    ...
    const getUserData = async()=>{
        const res = await axios.get("https://fileupload-3h0b.onrender.com/api/getdata"
          );
        // console.log(res);
            ...
            <div className="container mt-2">
                ...
                <div className="row d-flex justify-content-between align-iteams-center mt-5">
                {
                    data.length > 0 && data.map((element,index)=>{
                        ...
                        <Card.Img variant="top" src={element.profile_pic} style={{width:"100px",textAlign:"center",margin:"auto"}}
                        className='mt-2'
                         />
                        <Card.Body>
